...
- Trinoo
## Dos/DDoS 대응
- 침입 차단 시스템으로 패킷 및 포트 필터링 수행
- 침입 탐지 시스템으로 공격 탐지
- 로드 밸런싱으로 대용량 트래픽 분산 처리
- 최신 패치로 취약점 제거
- 불필요한 서비스 제거 및 포트 폐쇄
# 2. 해킹 공격
## 무작위 공격 도구
### 개념
- 임의의 정보를 무작위로 대입하여 인증 우회
- 고정된 아이디, 사전적 단어의 사용은 뚫리기 쉬움
### 무작위 공격 도구 및 대응 방안
- 'John the Ripper' 무작위 공격 도구 오픈 소스
- 입력 회수 제한 등으로 대응
## 기타 해킹 프로그램 및 악성 코드
- Prorat : 원격 접속 및 제어하여 해킹 수행
- Netbus : 윈도우 컴퓨터 시스템 원격 제어
- Back orifice : TCP/IP 기능을 통한 
- 랜섬웨어
- 트로이목마
- 웜바이러스
