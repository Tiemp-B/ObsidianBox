...
7. 분산 처리 시스템(Distribute Processing System)
	- 독립적인 시스템 간의 통신망을 연결하고 시스템이 수행해야 할 작업을 분산하고 각 시스템의 자원을 공유하여 처리량과 응답시간, 가용량을 극대화한다
	- 둘 이상의 독립된 시스템이 통신으로 연결되고 상호작용하는 약결합 방식
	- 물리적 시스템 간 연결을 넘어 유휴 자원의 효율적 활용을 위해 가상화 기술을 통해 가상화 시스템 간, 가상화 시스템과 물리적 시스템 간의 분산 처리 형태로 진화
...
3. Linux
	...
	- 리차드 스톨만이 진행하는 [[GNU]] 프로젝트는 리눅스 커널에서 동작할 수 있는 다양한 애플리케이션을 개발 및 제공
	- 데스크톱용 배포판
		- [[Ubuntu]]
		- [[Fedora]]
		- [[Debian]]
...
3. Tizen
	...
	- 스마트 TV 및 스마트 워치등으로 플랫폼 확산중
4. Embedded Linux
	- 라즈비안은 라즈베리파이용 데비안 리눅스 기반 OS
	- webOS는 LG 전자에서 개발중인 모바일 및 IoT 등을 위한 OS
	- 
